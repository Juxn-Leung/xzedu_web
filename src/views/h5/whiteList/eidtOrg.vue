        ...
        <FormItem label="选择机构状态">
          ...
          >
            <template v-for="item in list6.picker">
              <Option v-model="item.id">{{item.name}}</Option>
            </template>
          </Select>
        </FormItem>
      </Form>
...
<script>
import { attendGetInfo, getAreaList, wEdit, wOrgDetail } from "@/api";
...
export default {
  ...
  created() {
    ...
    this.formItem.orgId = this.$route.query.id;
    this.wOrgDetail(this.$route.query.id);
  },
  ...
  methods: {
    ...
    wOrgDetail(id) {
      wOrgDetail({ id }).then((res) => {
        console.log(res);
        if (res.code == 200) {
          let result = res.result;
          let regAreaId = [1964, 2123, result.regAreaId];
          let areaId = [1964, 2123, result.areaId];
          if (result.establishDate !== null && result.establishDate !== "") {
            var time1 = Date.parse(new Date(result.establishDate));
            var establishDate = new Date(parseInt(time1));
          } else {
            var establishDate = "";
          }
          ...
          let list1 = [
            ...
            },
            {
              ...
              content: result.businessAddress,
              picker: [],
              type: "text",
              no: 0,
            },
            ...
            },
            {
              title: "举办者属性",
              placeholder: "",
              content: result.organizerTypeStr || [],
              picker: [
                { id: 0, name: "个人" },
                { id: 1, name: "企业" },
                { id: 2, name: "个体工商户" },
          ...
          let list2 = [
            ...
            },
            {
              ...
              placeholder: "",
              content:
                result.issuingDeptId === "" ? null : result.issuingDeptId,
              picker: [
                { id: 0, name: "市场监管部门" },
                { id: 1, name: "教育行政部门" },
                { id: 2, name: "人力社保行政部门" },
            ...
            },
            {
              title: "法人登记部门",
              placeholder: "",
              content: result.lprDeptId === "" ? null : result.lprDeptId,
              picker: [
                { id: 0, name: "工商部门" },
                { id: 1, name: "民政部门" },
              ],
            ...
            },
            {
              ...
              placeholder: "",
              content:
                result.hasTrainContent === "" ? null : result.hasTrainContent,
              picker: [
                {
                  id: 0,
                  name: "否",
          ...
          let list3 = [
            {
              title: "培训类别",
              placeholder: "",
              content: result.trainTypeStr === "" ? null : result.trainTypeStr,
              picker: [
                { id: 0, name: "中小学学科类" },
            ...
            },
            {
              title: "招生对象",
              placeholder: "请输入招生对象",
              content: result.enrollmentTarget,
              picker: [],
              type: "text",
              no: 2,
            },
            ...
            },
            {
              ...
              content: result.lastTrainNumber || null,
              picker: [],
              type: "number",
              no: 2,
            },
            {
              ...
              content: result.nowStudentNumber || null,
              picker: [],
              type: "number",
              no: 2,
            },
          ...
          let list4 = [
            {
              title: "培训学科",
              placeholder: "请输入培训学科",
              content: result.pmSchoolSubject,
              picker: [],
              type: "text",
              no: 3,
            },
            {
              title: "培训形式",
              content: result.trainSubjectFormStr || [],
              picker: [
                { id: 0, name: "面授" },
                { id: 1, name: "在线培训" },
              ],
          ...
          let list5 = [
            {
              title: "场地性质",
              placeholder: "",
              content: result.placeTypeId === "" ? null : result.placeTypeId,
              picker: [
                { id: 0, name: "租用" },
                { id: 1, name: "自有" },
                { id: 2, name: "其他" },
            ...
            },
            {
              ...
              content: result.teacherNum || null,
              picker: [],
              type: "number",
              no: 4,
            },
            {
              ...
              content: result.fteacherNum || null,
              picker: [],
              type: "number",
              no: 4,
            },
            {
              ...
              content: result.cteacherNum || null,
              picker: [],
              type: "number",
              no: 4,
            },
            {
              ...
              content: result.pteacherNum || null,
              picker: [],
              type: "number",
              no: 4,
            },
            {
              ...
              placeholder: "",
              content:
                result.isFireControl === "" ? null : result.isFireControl,
              picker: [
                {
                  id: 0,
                  name: "否",
            ...
            },
            {
              title: "是否寄宿",
              placeholder: "",
              content: result.ifBoard === "" ? null : result.ifBoard,
              picker: [
                {
                  id: 0,
                  name: "否",
            ...
            },
            {
              title: "是否提供餐饮",
              placeholder: "",
              content: result.ifFood === "" ? null : result.ifFood,
              picker: [
                {
                  id: 0,
                  name: "否",
            ...
            },
            {
              title: "有无餐饮服务许可证",
              placeholder: "",
              content: result.ifCslicense === "" ? null : result.ifCslicense,
              picker: [
                {
                  id: 0,
                  name: "无",
          ...
          this.list6.content = result.ifLegal;
          this.formItem.ifLegal = result.ifLegal;
