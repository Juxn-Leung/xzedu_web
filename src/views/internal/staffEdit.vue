...
<script>
import { roleList, myFunList, userEdit } from "../../api/index";
export default {
  data() {
    return {
      tableHeight: null,
  ...
  methods: {
    ...
    getMessage() {
      let cont = this.$route.query;
      console.log(cont);
      this.formValidate.name = cont.name;
      this.formValidate.id = cont.id;
      this.formValidate.phone = cont.phone;
      this.formValidate.sex = Number(cont.sex);
      this.formValidate.teaching = Number(cont.teaching);
      this.formValidate.orgId = cont.orgId;
      this.formValidate.roleId = Number(cont.roleId);

      this.myFunList(cont.roleId);
    },
