    ...
    <div class="tab_panel">
      <div class="tab_head">
        <Tabs :value="$router.currentRoute.name">
          <TabPane label="认证信息" name="bianenteCertification"></TabPane>
        </Tabs>
      </div>
  ...
  methods: {
    ...
    handleEdit() {
      ...
      authenDetail(objc).then((res) => {
        ...
        this.shu = true;
        this.formData1.trainOrgname = res.result.orgName;
        this.formData1.trainOrgmobile = res.result.mobile;
        this.formData1.businessAddress = res.result.address;
        ...
        let addId_list = [];
        addId_list = res.result.area.split(",");
        let id0 = addId_list[0];
        let id1 = addId_list[1];
        let id2 = addId_list[2];
        this.formData1.myArea = id2;
        this.formData1.myCity = id1;
        this.formData1.myProvince = id0;
        // let addId_list2 = [];
        ...
        if (res.result.businessImgUrl !== "") {
          this.tipg = true;
          this.formData1.uscCodeImg = res.result.businessImgUrl;
          this.avatarList2.push(res.result.businessImgUrl);
        }

        if (res.result.EducationImgUrl !== "") {
          this.tipg2 = true;
          this.formData1.srlNoImg = res.result.EducationImgUrl;
