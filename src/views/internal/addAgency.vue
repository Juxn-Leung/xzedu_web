    ...
    <div class="tab_panel">
      <div class="tab_head">
        <Tabs v-if="typex == 0" :value="$router.currentRoute.name">
          <TabPane label="添加机构" name="addAgency"></TabPane>
        </Tabs>
        <Tabs v-if="typex == 1" :value="$router.currentRoute.name">
          <TabPane label="编辑机构" name="addAgency"></TabPane>
        </Tabs>
      </div>
      ...
      <div class="tab_content" :style="`height:${tableHeight}px;`">
        <div class="information">
          ...
          >
            <div class="taba">
              <FormItem label="LOGO:" :disabled="shu">
                <div
                ...
                <Modal title="查看" :closable="false" v-model="visible">
              ...
              <FormItem label="机构负责人:" prop="branchName">
                <Input
                  :disabled="shu"
              ...
              <FormItem label="负责人电话:" prop="branchMobile">
                <Input
                  :disabled="shux"
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.ifFinal = this.$route.query.ifFinal;
      if (this.ifFinal == 0) {
        this.formItem.branchMobile = this.mobile;
        this.shux = true;
      }
    },
