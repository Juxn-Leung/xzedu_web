<template>
  <div class="main">
    <!-- 左侧菜单栏 -->
    <div
      class="sidebar-menu-con menu-bar Oxford-blue"
      :style="{width: shrink?'60px':'240px', overflow: shrink ? 'visible' : 'visible'}"
    >
      <div slot="top" class="logo-con">
        <div v-show="!shrink" class="max-title">教育培训机构云服务</div>
    ...
    <!-- 右侧头部 -->
    <div class="main-header-con Oxford-blue" :style="{paddingLeft: shrink?'60px':'240px'}">
      <!-- 头部top -->
    ...
    <!-- 右侧内容部分 -->
    <div class="single-page-con Oxford-blue" :style="{left: shrink?'60px':'240px'}">
      <!-- 动态组件 -->
...
import '../assets/ski/Oxford-blue/main.css';  // 暗蓝色皮肤包 使用关键字 Oxford-blue
...
export default {
  ...
  methods: {
    ...
    getUserInfo() {
      ...
      if(this.userInfo.type=="INNER"){
        this.affiliatedUnit = "超级管理员"
      }else {
        this.affiliatedUnit = this.userInfo.orgList[0].name;
      }
